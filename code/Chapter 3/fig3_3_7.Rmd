...
print(heatmap_full)
# export the plot
ggsave(plot = heatmap_full, file = "./figures/fig3_3.png")
```
...
yellow
# export the plot
ggsave(plot = yellow, file = "./figures/fig3_7.png", units = "mm", device = ragg::agg_png, height = 200, width = 350, scaling = 1, limitsize = FALSE)
```
