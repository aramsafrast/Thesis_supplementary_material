...
# load libraries
devtools::install_github("aramsafrast/cvms")
...
# npj data prep - filter only those markers and combine with metadata
...
# get the testing phase data for future use
...
# get the testing phase results for future use
...
save(npj_mark_rf, elife_mark_rf, all_mark_rf, npj1, npj2, elife1, elife2, comb1, comb2, npj_npj, elife_npj, comb_npj, file = "./data/marker_res.RData")
```
